...
\only<1-2>{
      \item[-] Identificação de tabelas
      \item[-] Identificação de itens
}

\only<3->{
      \item[-] \alert{Identificação de tabelas}
      \item[-] \alert{Identificação de itens}
}

\only<1->{
      \item[-] Identificação de template
}

\only<2->{
      \item[-] \alert{Identificação de estruturas em geral}
}
