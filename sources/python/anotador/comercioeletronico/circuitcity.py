...
def crawl(url, out=None):
    ...
    productList = [doc.xpath('//form[@name="frmCompare"]/table')[0]]
    ...
    products = productList[0].childNodes
#    products = doc.xpath('//div[@class="lview"]/table[@class="lview nol"]')
